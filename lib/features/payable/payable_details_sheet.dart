...
// payable_screen.dart, which only knows about PayableDetailsSheet(item).
// ------------------------------------------------------------------
...
const _kAccent = Color(0xFF0C447C); // Payable / money out

class PayableDetailsSheet extends StatelessWidget {
  final Payable item;

  const PayableDetailsSheet({super.key, required this.item});

  Future<void> _sharePayableDetails(BuildContext context) async {
    try {
  ...
  Widget build(BuildContext context) {
    ...
    final total = item.payableAmount ?? 0.0;
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Text('VENDOR', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 0.6)),
                          ),
                ...
                child: SafeArea(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () => _sharePayableDetails(context),
