...
class LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      extendBody: true, // 🌟 Extends the background all the way down behind the gesture bar
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            SafeArea(
              bottom: false, // 🌟 Lets the bottom content flow transparently under the gesture bar
              child: Center(
