...
import 'package:sas_akount_login/screens/custom_drawer.dart';
...
import 'package:sas_akount_login/utils/sync_service.dart';
import 'package:sas_akount_login/screens/inventory_screen.dart';
import 'package:sas_akount_login/screens/ageing_screen.dart';

// ============================================================================
// HOME PAGE: (Reverted to fast IndexedStack to match the instant tab switch in your video)
// ============================================================================
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // We use IndexedStack so the tabs switch instantly, letting the Shimmer handle the animation
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _fetchData() async {
    ...
    // 🔥 Optional: Add a slight delay here during development just so you can admire the shimmer effect!
    // await Future.delayed(const Duration(milliseconds: 800));

    try {
      final data = await _apiService.fetchDashboardSummary(period: _selectedPeriod, startDate: _customRange?.start, endDate: _customRange?.end);
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        // 👉 THE MAGIC HAPPENS HERE: If loading, show skeleton. Else, show actual data.
        child: _isLoading 
